...
function sendEmailOnSubmit(e) {
  try {
    ...
    var name = sheet.getRange(lastRow, 2).getValue();      // Column B
    var email = sheet.getRange(lastRow, 3).getValue();     // Column C
    var message = sheet.getRange(lastRow, 4).getValue();   // Column D
    ...
    var htmlMessage = "<p>Hello " + name + ",</p>" +
                  "<p style='color:green; font-weight:bold;'>✅ Successful Registration!</p>" +
                  "<p>Thank you for registering. Your data has been received and recorded successfully.</p>" +
